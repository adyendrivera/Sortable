...
1.  Try [master](https://github.com/adyendrivera/Sortablee/tree/master/)-branch, perhaps the problem has been solved;
2.  [Use the search](https://github.com/adyendrivera/Sortablee/search?type=Issues&q=problem), maybe already have an answer;
...
1.  Only request to merge with the [master](https://github.com/adyendrivera/Sortablee/tree/master/)-branch.
